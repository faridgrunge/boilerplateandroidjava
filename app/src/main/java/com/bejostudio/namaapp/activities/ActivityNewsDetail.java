package com.bejostudio.namaapp.activities;
...
public class ActivityNewsDetail extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(Config.hitungBackStartApp % Integer.parseInt(getString(R.string.counter_back_startapp)) == 0){
           // super.onBackPressed();
            StartAppAd.showAd(ActivityNewsDetail.this);
        }else{
           // super.onBackPressed();
        }
